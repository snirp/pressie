...
var parseBegroting = function(scenarioJson, horizon, detail, btw) {
    var startScenario = 2015; // TODO set dynamically
    ...
    // Main parsing loop
    for (var h = 0; h < scenarioJson.length; h++) {
        var sc = scenarioJson[h];

        for (var i = 0; i < sc.scenariogroepen.length; i++) {
            var sg = sc.scenariogroepen[i];
